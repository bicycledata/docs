...
In other words, TrafficLogger is updatable, configurable, and accessible (via SSH) if it is connected to the internet – which it is whenever it is turned on and the `bicycledata` network is available to it. 
...
- Sensor implementations
    - [lochel/bicyclelidar](https://github.com/bicycledata/bicyclelidar)
    - [lochel/bicyclegps](https://github.com/bicycledata/bicyclegps)
